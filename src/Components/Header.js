    ...
    <>
      <div style={{ background: '#ABC0DE' }}>
        <div className='p-5' style={{ background: '#edf2f7' }}>
          <div>
            <nav className="bg-white  fixed w-full z-20 top-0 left-0 border-b border-gray-200 " style={{ background: '#F2F0F1' }}>
              <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="/" className="flex items-center">
               <p className='text-xl text-black font-bold shadow-lg shadow-black'> Saanu</p>
                </a>
                <div className="flex md:order-2">
                  <button type="button" onClick={openPopup} className=" bg-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-0 text-sm px-4 py-2 text-center mr-3 md:mr-0 " style={{ color: 'blue ' }}>New</button>
                  <button type="button" onClick={openPopup1} className="ml-1 bg-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-0 text-sm px-4 py-2 text-center mr-3 md:mr-0 " style={{ color: 'blue ' }} >Import</button>
                  <button type="button" onClick={openPopup2} className="ml-1 bg-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-0 text-sm px-4 py-2 text-center mr-3 md:mr-0 " style={{ color: 'blue ' }} >Add to campaign</button>
                  <button type="button" onClick={openPopup3} className="ml-1 bg-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-0 text-sm px-4 py-2 text-center mr-3 md:mr-0 " style={{ color: 'blue ' }} >change Status</button>
                  <button type="button" onClick={openPopup4} className="ml-1 bg-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-0 text-sm px-4 py-2 text-center mr-3 md:mr-0 " style={{ color: 'blue ' }} >Change Owner</button>
                </div>
              </div>
            </nav>
          </div>
            ...
            <div className="bg-white  p-4 relative rounded-0" style={{ width: '900px', height: '400px' }}>
              ...
              <div style={{ maxHeight: 'calc(100% - 40px)', overflowY: 'auto', marginTop: '50px' }}>
                ...
                <div className="relative w-full mt-5">
                  <input type="search" id="search-dropdown" className="block p-2.5 w-full z-20 text-sm  rounded-r-lg  border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Search Mockups, Logos, Design Templates..." required />
              ...
              <div
                className="p-4  text-sm text-gray-800 rounded-0  "
